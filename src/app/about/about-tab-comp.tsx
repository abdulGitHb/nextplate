...
const AboutTabComp = () => {
  ...
  const tabs = [
    ...
    { label: 'MISSION', heading:'Our Mission', image: 'https://res.cloudinary.com/dmquwnaeb/image/upload/f_auto,q_auto/v1/talentWorkx/btni3qrzctflhuc4w598', 
    content:["Our mission 2030:","“Propelling towards industry leadership”.", "Fueled by innovation and a commitment to excellence, we're on a transformative journey to make a change in the industry. Our dynamic team, cutting-edge tech, and strategic foresight propel us towards this ambitious milestone. Beyond financial success, it's about cultivating trust, partnerships, and a culture of", "“Growth and innovation”."]
    },
    { label: 'VISION', heading:'Our Vision', image:'https://res.cloudinary.com/dmquwnaeb/image/upload/f_auto,q_auto/v1/talentWorkx/ha3j55sa8c7hvfcrc9i4', 
